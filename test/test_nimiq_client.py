...
class TestNimiqClientMethods(unittest.TestCase):
    ...
    def test_peerNormal(self):
        ...
        result = self.client.peer_state("wss://seed1.nimiq-testnet.com:8080/b99034c552e9c0fd34eb95c1cdf17f5e")
    ...
    def test_peerFailed(self):
        ...
        result = self.client.peer_state("wss://seed4.nimiq-testnet.com:8080/e37dca72802c972d45b37735e9595cf0")

        self.assertEqual("peerState", SessionStub.latest_request_method)
        self.assertEqual("wss://seed4.nimiq-testnet.com:8080/e37dca72802c972d45b37735e9595cf0", SessionStub.latest_request_params[0])
    ...
    def test_sendRawTransaction(self):
        ...
        result = self.client.send_raw_transaction("")
    ...
    def test_getRawTransactionInfo(self):
        ...
        result = self.client.get_raw_transaction_info("")
    ...
    def test_getTransactionByBlockHashAndIndex(self):
        ...
        result = self.client.get_transaction_by_block_hash_and_index("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786", 0)

        self.assertEqual("getTransactionByBlockHashAndIndex", SessionStub.latest_request_method)
        self.assertEqual("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786", SessionStub.latest_request_params[0])
    ...
    def test_getTransactionByBlockHashAndIndexWhenNotFound(self):
        ...
        result = self.client.get_transaction_by_block_hash_and_index("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786", 5)
    ...
    def test_getTransactionByBlockNumberAndIndex(self):
        ...
        self.assertEqual("getTransactionByBlockNumberAndIndex", SessionStub.latest_request_method)
    ...
    def test_getTransactionByHash(self):
        ...
        result = self.client.get_transaction_by_hash("78957b87ab5546e11e9540ce5a37ebbf93a0ebd73c0ce05f137288f30ee9f430")

        self.assertEqual("getTransactionByHash", SessionStub.latest_request_method)
        self.assertEqual("78957b87ab5546e11e9540ce5a37ebbf93a0ebd73c0ce05f137288f30ee9f430", SessionStub.latest_request_params[0])
    ...
    def test_getTransactionByHashForContractCreation(self):
        ...
        result = self.client.get_transaction_by_hash("539f6172b19f63be376ab7e962c368bb5f611deff6b159152c4cdf509f7daad2")

        self.assertEqual("getTransactionByHash", SessionStub.latest_request_method)
        self.assertEqual("539f6172b19f63be376ab7e962c368bb5f611deff6b159152c4cdf509f7daad2", SessionStub.latest_request_params[0])
    ...
    def test_getTransactionReceipt(self):
        ...
        result = self.client.get_transaction_receipt("fd8e46ae55c5b8cd7cb086cf8d6c81f941a516d6148021d55f912fb2ca75cc8e")

        self.assertEqual("getTransactionReceipt", SessionStub.latest_request_method)
        self.assertEqual("fd8e46ae55c5b8cd7cb086cf8d6c81f941a516d6148021d55f912fb2ca75cc8e", SessionStub.latest_request_params[0])
    ...
    def test_getTransactionsByAddress(self):
        ...
        result = self.client.get_transactions_by_address("NQ05 9VGU 0TYE NXBH MVLR E4JY UG6N 5701 MX9F")

        self.assertEqual("getTransactionsByAddress", SessionStub.latest_request_method)
        self.assertEqual("NQ05 9VGU 0TYE NXBH MVLR E4JY UG6N 5701 MX9F", SessionStub.latest_request_params[0])
    ...
    def test_getTransactionsByAddressWhenNoFound(self):
        ...
        result = self.client.get_transactions_by_address("NQ10 9VGU 0TYE NXBH MVLR E4JY UG6N 5701 MX9F")

        self.assertEqual("getTransactionsByAddress", SessionStub.latest_request_method)
        self.assertEqual("NQ10 9VGU 0TYE NXBH MVLR E4JY UG6N 5701 MX9F", SessionStub.latest_request_params[0])
    ...
    def test_getWorkWithOverride(self):
        ...
        result = self.client.get_work("NQ46 NTNU QX94 MVD0 BBT0 GXAR QUHK VGNF 39ET", "")

        self.assertEqual("getWork", SessionStub.latest_request_method)
        self.assertEqual("NQ46 NTNU QX94 MVD0 BBT0 GXAR QUHK VGNF 39ET", SessionStub.latest_request_params[0])
    ...
    def test_getBlockTemplateWithOverride(self):
        ...
        result = self.client.get_block_template("NQ46 NTNU QX94 MVD0 BBT0 GXAR QUHK VGNF 39ET", "")
    ...
    def test_getAccountForVestingContract(self):
        ...
        self.assertEqual("getAccount", SessionStub.latest_request_method)
        self.assertEqual("NQ09 VF5Y 1PKV MRM4 5LE1 55KV P6R2 GXYJ XYQF", SessionStub.latest_request_params[0])
    ...
    def test_getBlockTransactionCountByHash(self):
        ...
        result = self.client.get_block_transaction_count_by_hash("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786")

        self.assertEqual("getBlockTransactionCountByHash", SessionStub.latest_request_method)
        self.assertEqual("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786", SessionStub.latest_request_params[0])
    ...
    def test_getBlockTransactionCountByNumber(self):
        ...
        self.assertEqual("getBlockTransactionCountByNumber", SessionStub.latest_request_method)
        self.assertEqual(11608, SessionStub.latest_request_params[0])
    ...
    def test_getBlockByHash(self):
        ...
        result = self.client.get_block_by_hash("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786")
    ...
    def test_getBlockByHashWithTransactions(self):
        ...
        result = self.client.get_block_by_hash("bc3945d22c9f6441409a6e539728534a4fc97859bda87333071fad9dad942786", True)
